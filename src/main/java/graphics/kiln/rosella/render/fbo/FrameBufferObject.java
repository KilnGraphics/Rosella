...
public class FrameBufferObject {
    ...
    private void setupFboUsingExperimentalStuff(Swapchain swapchain, VkCommon common, RenderPass renderPass) {
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VkFramebufferAttachmentImageInfo.Buffer attachmentImageInfos = VkFramebufferAttachmentImageInfo.calloc(2, stack);
            ...
            VkFramebufferAttachmentsCreateInfo.Buffer attachmentCreateInfo = VkFramebufferAttachmentsCreateInfo.calloc(1, stack)
