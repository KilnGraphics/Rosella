...
public class VertexFormatElements {
    ...
    public static final VertexFormatElement VEC3f = getElement(VK10.VK_FORMAT_R32G32B32_SFLOAT, VertexFormatElement.DataType.FLOAT.getByteLength() * 3);
    ...
    public static final VertexFormatElement NORMALf = getElement(VK10.VK_FORMAT_R32G32B32_SFLOAT, VertexFormatElement.DataType.FLOAT.getByteLength() * 3);
